...
class TestEnsembleModels:
    ...
    def test_extreme_lag_inference(self):
        ...
        ensemble = NaiveEnsembleModel([model1, model2])  # test if infers extreme lags is okay
    ...
    def test_stochastic_naive_ensemble(self):
        ...
        forecast_mean = 0.5 * model_alone_1.predict(5, num_samples=num_samples) + 0.5 * model_alone_2.predict(
    ...
    def test_predict_likelihood_parameters_univariate_naive_ensemble(self):
        ...
        m_proba_quantile3 = DLinearModel(
            input_chunk_length=4, output_chunk_length=2, likelihood=QuantileRegression([0.05, 0.5, 0.95]), **tfm_kwargs
        )
