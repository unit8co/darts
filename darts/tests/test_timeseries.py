...
class TestTimeSeries:
    ...
    def test_resample_timeseries(self):
        ...
        with pytest.raises(KeyError):
            resampled_timeseries.pd_series().at[
        ...
        assert (
            resampled_timeseries.pd_series().at[pd.Timestamp("20130103")] == 1
        )  # group: [2,3] -> 0
        ...
        assert (
            resampled_timeseries.pd_series().at[pd.Timestamp("20130101")] == 1
        )  # group: [0,1] -> 1
        assert (
            resampled_timeseries.pd_series().at[pd.Timestamp("20130103")] == 1
        )  # group: [2,3] -> 1
        ...
        assert (
            resampled_timeseries.pd_series().at[pd.Timestamp("20130101000000")] == 0
        )  # day 1, 0h -> 0
        assert pd.isna(
            resampled_timeseries.pd_series().at[
        ...
        assert (
            resampled_timeseries.pd_series().at[pd.Timestamp("20130101120000")] == 1
        )  # hole in day 1 -> 1, from day 2
        assert (
            resampled_timeseries.pd_series().at[pd.Timestamp("20130102000000")] == 1
        )  # day 2 -> 1
        ...
        assert (
            resampled_timeseries.pd_series().at[pd.Timestamp("20130101")] == 2
        )  # days 1,2 grouped -> 2
        assert (
            resampled_timeseries.pd_series().at[pd.Timestamp("20130103")] == 2
        )  # days 3,4 grouped -> 2
        ...
        assert (
            resampled_timeseries.pd_series().at[pd.Timestamp("20130101120000")] == 0
        )  # day 1 -> 0
        assert (
            resampled_timeseries.pd_series().at[pd.Timestamp("20130101000000")] == 0
        ...
        assert (
            resampled_timeseries.pd_series().at[pd.Timestamp("20130103")] == 3
        ...
        assert (
            resampled_timeseries.pd_series().at[pd.Timestamp("20130101")] == 0.5
        )  # days 1,2 group: [0,1] -> 0.5
        assert (
            resampled_timeseries.pd_series().at[pd.Timestamp("20130103")] == 2.5
        ...
        assert (
            resampled_timeseries.pd_series().at[pd.Timestamp("20130104")] == 4
        ...
        assert (
            resampled_timeseries.pd_series().at[pd.Timestamp("20130101")] == 0.05
        )  # days 1,2 group: [0,1] -> 0.05
        assert (
            resampled_timeseries.pd_series().at[pd.Timestamp("20130103")] == 2.05
        ...
        assert (
            resampled_timeseries.pd_series().at[pd.Timestamp("20130103")] == 0.5
        ...
        assert (
            resampled_timeseries.pd_series().at[pd.Timestamp("20130103")] == 5
        ...
        assert (
            resampled_timeseries.pd_series().at[pd.Timestamp("20130101")] == 0.25
        )  # days 1,2 group: [0,1] -> 0.25
        assert (
            resampled_timeseries.pd_series().at[pd.Timestamp("20130103")] == 0.25
