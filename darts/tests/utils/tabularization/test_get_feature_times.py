...
class GetFeatureTimesTestCase(DartsBaseTestClass):
    """
    Tests `get_feature_times` function defined in `darts.utils.data.tabularization`. There
    are broadly two 'groups' of tests defined in this module:
        1. 'Generated Test Cases': these test that `get_feature_times` produces the same outputs
        ...
        2. 'Specified Test Cases': these test that `get_feature_times` returns an exactly specified output; these
    ...
    def test_feature_times_training_range_idx(self):
        """
        Tests that `get_feature_times` produces the same `times` output as
    ...
    def test_feature_times_training_single_time_range_idx(self):
        """
        Tests that `get_feature_times` correctly handles case where only
    ...
    def test_feature_times_extend_time_index_range_idx(self):
        """
        Tests that `get_feature_times` is able to return feature
    ...
    def test_feature_times_future_lags_range_idx(self):
        """
        Tests that `get_feature_times` correctly handles the `lags_future_covariates`
    ...
    def test_feature_times_unspecified_series(self):
        """
        Tests that `get_feature_times` correctly returns
    ...
    def test_feature_times_unspecified_lag_or_series_warning(self):
        """
        Tests that `get_feature_times` throws correct warning when
