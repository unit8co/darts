                ...
                if (
                    ...
                    if start_time_ < historical_forecasts_time_index[0]:
                        ...
                        logger.warning(
                            ...
                            f"forecasts. Ignoring `start` for this series and beginning at first trainable/predictable "
                            f"time: {historical_forecasts_time_index[0]}. Non-empty forecasts can be generated by "
                            f"setting `start` value to times between (including): "
