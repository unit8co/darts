...
class GlobalForecastingModel(ForecastingModel, ABC):
    ...
    def generate_fit_encodings(
        ...
        """Generates covariate encodings for the fit/training set and returns new covariate series with the
        original and encoded covariates stacked together. The encodings are generated by the encoders defined at model
        creation with parameter `add_encoders`.

        Parameters
        ----------
        series
            A series or sequence of series containing the target values.
        past_covariates
    ...
    def generate_predict_encodings(
        ...
        """Generates covariate encodings for the inference/prediction set and returns new covariate series with the
        original and encoded covariates stacked together. The encodings are generated by the encoders defined at model
        creation with parameter `add_encoders`.
