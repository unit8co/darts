...
class ForecastingModel(ABC, metaclass=ModelMeta):
    ...
    def historical_forecasts(
        ...
        start
            ...
            Note: Raises a ValueError if the provided value is outside the possible historical forecasting times.
        forecast_horizon
                ...
                if (
                    ...
                    if start_time_ < historical_forecasts_time_index[0]:
                        ...
                        logger.warning(
                            ...
                            f"forecasts. Non-empty forecasts can be generated by setting `start` value to times "
                            f"between (including): "
