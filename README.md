...
| **Foundation Models (Pre-trained, Zero-Shot)**<br/>([FoundationForecastingModel](#foundation-models))                                                                                                                                                                                              | Pre-trained on 100B+ time points for zero-shot forecasting                                                                                                                                                                                       |                                                              |                                                                          |                                                                          |                                           |
| [TimesFMModel](https://unit8co.github.io/darts/generated_api/darts.models.forecasting.timesfm_model.html#darts.models.forecasting.timesfm_model.TimesFMModel)                                                                                                                                       | [Google TimesFM](https://arxiv.org/abs/2310.10688), [GitHub](https://github.com/google-research/timesfm), [HuggingFace](https://huggingface.co/google/timesfm-2.5-200m-pytorch)                                                 | ✅ 🔴                                                         | 🔴 🔴 🔴                                                                 | 🔴 🔴                                                                    | ✅                                         |
| [ChronosModel](https://unit8co.github.io/darts/generated_api/darts.models.forecasting.chronos_model.html#darts.models.forecasting.chronos_model.ChronosModel)                                                                                                                                       | [Amazon Chronos](https://arxiv.org/abs/2403.07815), [GitHub](https://github.com/amazon-science/chronos-forecasting), [HuggingFace](https://huggingface.co/amazon/chronos-2)                                                      | ✅ 🔴                                                         | 🔴 🔴 🔴                                                                 | ✅ ✅                                                                      | ✅                                         |
...
**Note on Foundation Models:** Foundation models are pre-trained on massive datasets (100+ billion time points) and can perform zero-shot forecasting without requiring `fit()`. They represent a paradigm shift from traditional models. See the [Foundation Models User Guide](https://unit8co.github.io/darts/userguide/foundation_models.html) for details on zero-shot vs few-shot vs fine-tuning.
