...
- Added resampling methods to `TimeSeries.resample()`. This allows to aggregate values when down-sampling and to fill or keep the holes when up-sampling. [#699](https://github.com/unit8co/darts/issues/699) by [Jonas Blanc](https://github.com/jonasblanc)
