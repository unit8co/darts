...
- 🟠 `TimeSeries.pd_dataframe()` and `TimeSeries.pd_series()` now raise a deprecation warning and will be removed in Darts version 0.35.0. Use `to_dataframe()` and `to_series()` instead. [#2701](https://github.com/unit8co/darts/pull/2701) by [Jules Authier](https://github.com/authierj)
