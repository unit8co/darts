...
- Improvements to `ShapExplainer`:
  ...
  - Added `MSTL` as a `method` option for `extract_trend_and_seasonality`. [#1879](https://github.com/unit8co/darts/pull/1879) by [Alex Colpitts](https://github.com/alexcolpitts96)
