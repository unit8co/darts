...
- Other improvements:
  ...
  - Added new arguments `fit_kwargs` and `predict_kwargs` to `historical_forecasts()`, `backtest()` and `gridsearch()` that will be passed to the corresponding methods of the model, allowing for example to pass validation series or to specify `num_loader_workers`. [#2050](https://github.com/unit8co/darts/pull/2050) by [Antoine Madrona](https://github.com/madtoinou)
