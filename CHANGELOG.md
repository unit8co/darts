...
- 🚀🚀 Added MLflow integration do Darts for automated tracking, comparing, and persisting of your Darts forecasting model experiments; including full support for local and global forecasting. [#3022](https://github.com/unit8co/darts/pull/3022) by [Jakub Chłapek](https://github.com/jakubchlapek), [Zhihao Dai](https://github.com/daidahao), [Michel Zeller](https://github.com/mizeller), and [Dennis Bader](https://github.com/dennisbader).
  - `autolog()` automatically logs everything that is important for experimenting and comparing different model runs: model parameters, model artifacts, rich standalone and backtest metric results, target and covariate series info, as well as PyTorch-related training metrics.
