...
- Removed the `pytorch-lightning` extra from `optuna-integration` in dev-only dependency groups to avoid pulling the `lightning` package. [#3097](https://github.com/unit8co/darts/pull/3097) by [Zhihao Dai](https://github.com/daidahao)
