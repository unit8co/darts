...
- Removed the `pytorch-lightning` extra from `optuna-integration` in dev-only dependency groups to avoid pulling the `lightning` package. [#](https://github.com/unit8co/darts/pull/) by [Zhihao Dai](https://github.com/daidahao)
