...
- Improved the documentation of how `WindowedAnomalyScorer` extract the training data from the input series. [#2672](https://github.com/unit8co/darts/pull/2672) by [Dennis Bader](https://github.com/dennisbader).
