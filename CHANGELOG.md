...
- Clarified the `Capturing model uncertainty using Monte Carlo Dropout` section of the `forecasting_overview.md` user guide to explain how `mc_dropout=True` interacts with the `likelihood`/`predict_likelihood_parameters` knobs. Closes [#3117](https://github.com/unit8co/darts/pull/3117) by [Jean-Baptiste Braun](https://github.com/jbbqqf).
