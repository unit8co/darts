...
- 🚀🚀 Added **Chronos-2**, the **first foundation model** for time series forecasting. `Chronos2Model` can be used for univariate, multivariate, and multiple time series forecasting without any training. It supports past and future covariates and can output determinstic or probabilistic forecasts. Check out the new [Chronos-2 Foundation Model Notebook](https://unit8co.github.io/darts/examples/24-SKLearnClassifierModel-examples.html) for examples and usage of Chronos-2. [#2944](https://github.com/unit8co/darts/pull/2944) by [Zhihao Dai](https://github.com/daidahao). Many thanks to [Dennis Bader](https://github.com/dennisbader) and [Abdul Fatir](https://github.com/abdulfatir) for their reviews.
- Added an example notebook demonstrating how to use Chronos-2: [Chronos-2 Foundation Model Examples](https://unit8co.github.io/darts/examples/25-Chronos-2-examples.html). [#2944](https://github.com/unit8co/darts/pull/2944) by [Zhihao Dai](https://github.com/daidahao).
