...
- Bumped minimum supported versions to `pandas>=2.2.0` and `numpy>=2.2.0`. Added support for `pandas 3.x`; removed backwards-compatibility code for pandas and numpy versions below 2.x.
