...
- Added a `uv` 7-day cooldown period to reduce supply-chain risk from newly published packages during dependency resolution. [#](https://github.com/unit8co/darts/pull/) by [Zhihao Dai](https://github.com/daidahao)
