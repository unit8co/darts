...
- Improvements to `EnsembleModel`:
  ...
  - Added `ReversibleInstanceNorm` as a new layer normalization option. [#1121](https://github.com/unit8co/darts/issues/1121) by [Alex Colpitts](https://github.com/alexcolpitts96)
