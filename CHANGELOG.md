...
- General model improvements:
  ...
  - Improved efficiency of `historical_forecasts()` and `backtest()` for all models giving significant process time reduction for larger number of predict iterations and series. [#1801](https://github.com/unit8co/darts/pull/1783) by [Dennis Bader](https://github.com/dennisbader). 
...
- Improvements to `ShapExplainer`:
  ...
  - New model: `TiDEModel`. An MLP based encoder-decoder model that outperforms many Transformer-based architectures. [#1727](https://github.com/unit8co/darts/pull/1727) by [Alex Colpitts](https://github.com/alexcolpitts96).
