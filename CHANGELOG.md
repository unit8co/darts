...
- Added `dtype` field to `TimeSeries.schema()` containing the series' data type. [#3163](https://github.com/unit8co/darts/pull/3163) by [Dennis Bader](https://github.com/dennisbader).
