...
- Added past covariates feature projection to `TiDEModel` following the advice of the model architect. [#1993](https://github.com/unit8co/darts/pull/1993) by [Dennis Bader](https://github.com/dennisbader).
