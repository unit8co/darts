...
- Added a weekly GitHub Actions workflow to run `uv audit` and fail CI when vulnerabilities are found in the dependencies. [#](https://github.com/unit8co/darts/pull/) by [Zhihao Dai](https://github.com/daidahao).
