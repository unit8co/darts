...
- Added `RINorm` (Reversible Instance Norm) as a new input normalization option for all `TorchForecastingModel`. Activate it with model creation parameter `user_reversible_instance_norm`. [#1969](https://github.com/unit8co/darts/pull/1969) by [Dennis Bader](https://github.com/dennisbader).
