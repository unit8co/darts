...
- Improvements to `EnsembleModel`:
  ...
  - 🔴 Changed name of `models` constructor's argument to `forecasting_models` in `EnsembleModel` and `NaiveEnsembleModel`. [#1815](https://github.com/unit8co/darts/pull/#1815) by [Antoine Madrona](https://github.com/madtoinou).
