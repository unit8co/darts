...
**Fixed**
- Fixed a bug in `coefficient_of_variaton()` when `intersect=True`. [#2202](https://github.com/unit8co/darts/pull/2202) by [Antoine Madrona](https://github.com/madtoinou).
