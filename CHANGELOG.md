...
New model: `QuerySelectorModel` implementing the Query Selector Model. [#1131](https://github.com/unit8co/darts/pull/1131) by [Greg DeVos](https://github.com/gdevos010).
